...
def main():
    ...
    group.add_argument("--latest", action="store_true", help="Print the latest semantic version (default).")
    group.add_argument("--all", action="store_true", help="Print all semantic versions in descending order.")
